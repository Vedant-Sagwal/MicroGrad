...
mlp.py => Implements Multi layer Perceptron
engine.py => implement Value class which is just like tensor but it is scalar only.
test.py => compares wit torch autograd
Micrograd.ipynb => Contains all the code and demo and everything.